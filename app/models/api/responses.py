...
class DashboardOverviewResponse(BaseResponse):
    ...
    data: Dict[str, List[StatCard]] = Field(..., description="Dashboard data containing stats")
...
class PerformanceMetricsData(BaseModel):
    ...
    monthlyGrowth: List[MonthlyGrowthData] = Field(..., description="Monthly growth data")
    entityPerformance: List[EntityPerformanceData] = Field(..., description="Entity performance data")
...
class RecentActivityData(BaseModel):
    ...
    recent_commissions: List[Dict[str, Any]] = Field(..., description="Recent commission records")
    monthly_commissions: List[Dict[str, Any]] = Field(..., description="Monthly commission summaries")
