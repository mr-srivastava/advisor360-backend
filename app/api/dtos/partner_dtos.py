...
class UpdatePartnerRequest(BaseModel):
    ...
    name: Optional[str] = Field(None, description="Partner name", min_length=2, max_length=255)
...
class PartnerPerformanceData(BaseModel):
    ...
    last_commission_date: Optional[datetime] = Field(None, description="Date of last commission")
...
class PartnerAnalyticsResponse(BaseResponse):
    ...
    performance_data: List[PartnerPerformanceData] = Field(..., description="Partner performance data")
