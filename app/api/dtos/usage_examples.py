...
def example_error_handling():
    ...
    from .common_dtos import ErrorResponse, ErrorDetail
...
def example_complex_mapping():
    ...
    partner_data = AnalyticsMapper.create_partner_commission_data(
        commissions, partners
    )
...
def example_dashboard_mapping():
    ...
    from .dashboard_dtos import DashboardMapper, StatCard
