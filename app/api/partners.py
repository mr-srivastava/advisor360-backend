...
from ..core.exceptions import PartnerNotFound, DomainException, DuplicateError, PartnerHasCommissions
...
async def list_partners(
    ...
    try:
        if entity_type:
            ...
            partners = await partner_service.get_partners_by_entity_type(entity_type_enum)
        elif search:
