...
class FinancialYear:
    ...
    def __post_init__(self):
        ...
        if self.end_year != self.start_year + 1:
            raise ValueError(f"Invalid financial year: end year must be start year + 1. Got {self.start_year}-{self.end_year}")
        
        if self.start_year < 1900 or self.start_year > 2100:
            raise ValueError(f"Financial year start year must be between 1900 and 2100. Got {self.start_year}")
    ...
    def from_string(cls, fy_string: str) -> "FinancialYear":
        ...
        raise ValueError(f"Invalid financial year format: {fy_string}. Expected formats: FY24-25, 2024-25, or 2024-2025")
    ...
    def to_string(self, format_type: str = "short") -> str:
        ...
        if format_type == "short":
            ...
            raise ValueError(f"Invalid format_type: {format_type}. Use 'short', 'medium', or 'long'")
