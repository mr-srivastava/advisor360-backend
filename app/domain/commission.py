...
class Commission:
    ...
    def _validate(self):
        ...
        if not self.financial_year.contains_date(self.transaction_date):
            raise ValueError(f"Transaction date {self.transaction_date} does not fall within financial year {self.financial_year}")
    ...
    @classmethod
    def create_new(cls, partner_id: str, amount: Money, transaction_date: date, 
    ...
    def __repr__(self) -> str:
        return (f"Commission(id='{self.id}', partner_id='{self.partner_id}', "
