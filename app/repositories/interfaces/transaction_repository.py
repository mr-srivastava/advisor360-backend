...
class ITransactionRepository(BaseRepository[Transaction]):
    ...
    @abstractmethod
    async def get_by_financial_year(self, financial_year: FinancialYear) -> List[Transaction]:
        """
    ...
    async def get_by_partner_and_financial_year(self, partner_id: str, 
                                               financial_year: FinancialYear) -> List[Transaction]:
        """
    ...
    @abstractmethod
    async def get_transaction_count_by_partner(self, partner_id: str, 
                                             financial_year: Optional[FinancialYear] = None) -> int:
        """
    ...
    @abstractmethod
    async def get_average_transaction_amount(self, partner_id: Optional[str] = None,
                                           financial_year: Optional[FinancialYear] = None) -> float:
        """
