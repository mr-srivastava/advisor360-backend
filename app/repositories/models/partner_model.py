...
class PartnerModel(BaseModel):
    ...
    entity_type_name: Optional[str] = Field(None, description="Entity type name from join")
    ...
    def from_database_row(cls, row: dict) -> "PartnerModel":
        ...
        return cls(
            ...
            entity_type_name=row.get("entity_type_name") or row.get("name")  # from entity_types join
        )
    ...
    def get_display_name(self) -> str:
        ...
        entity_type_name = self.entity_type_name or self._get_entity_type_from_id(self.type_id)
