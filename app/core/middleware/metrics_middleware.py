...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        self.endpoints: DefaultDict[str, Dict[str, Any]] = defaultdict(lambda: {
            'count': 0,
            'total_time': 0.0,
            'errors': 0,
            'avg_time': 0.0
        })
        self.hourly_stats: DefaultDict[str, Dict[str, Any]] = defaultdict(lambda: {
            'requests': 0,
            'errors': 0,
            'total_time': 0.0
        })
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'requests_per_second': round(
                ...
                if uptime.total_seconds() > 0 else 0.0, 2
            ),
    ...
    def get_hourly_stats(self, hours: int = 24) -> List[Dict[str, Any]]:
        ...
        for i in range(hours):
            ...
            avg_time = (
                ...
                if hour_stats['requests'] > 0 else 0.0
            )
            ...
            stats.append({
                ...
                'error_rate_percent': round(
                    ...
                    if hour_stats['requests'] > 0 else 0.0, 2
                )
            })
...
class MetricsMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        self,
        app,
        logger_name: str = "metrics_logger",
        log_interval_minutes: int = 60
    ):
        """
    ...
    def _should_log_metrics(self) -> bool:
        ...
        """
        now = datetime.utcnow()
        return (now - self.last_log_time).total_seconds() >= (self.log_interval_minutes * 60)
