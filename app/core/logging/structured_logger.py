...
class JSONFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if hasattr(record, 'structured_data'):
            try:
                structured = json.loads(record.structured_data) if isinstance(record.structured_data, str) else record.structured_data
...
class StructuredLogger:
    ...
    def log_business_event(
        ...
        self.info(f"Business event: {event_name} for {entity_type}:{entity_id}", extra_data)
